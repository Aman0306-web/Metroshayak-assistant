...
def main():
    ...
    # 1.5 Run dmrc_complete.py to generate CSV and verify data
    print("\n[INIT] Running dmrc_complete.py to verify data...")
    try:
        subprocess.run([sys.executable, "dmrc_complete.py"], check=True)
    except subprocess.CalledProcessError:
        print("[WARN] dmrc_complete.py failed, but attempting to start server anyway...")
